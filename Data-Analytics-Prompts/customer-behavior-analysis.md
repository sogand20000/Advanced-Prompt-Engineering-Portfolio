...
* **The Problem:** Using real customer data poses severe privacy risks (GDPR/CCPA compliance), while purely random data lacks the realistic trends and anomalies necessary for meaningful algorithmic testing.

## 2. The Strategy & Framework Design 🧠
To deliver an enterprise-grade data generation tool, I designed a pipeline that combines three advanced prompt engineering methodologies:
1. **Persona Pattern:** Establishing the AI as a Data Engineer and Simulation Expert to ensure technical and structural accuracy.
2. **JSON Schema Enforcing:** Providing a strict validation blueprint to guarantee that the output is syntactically flawless and ready for automated parsing.
...
*Here is the advanced system prompt developed for this data engineering pipeline:*
...
> 2. Inject a specific trend: Simulate a 'Weekend Surge' where purchasing volume and cart values triple on Saturdays and Sundays compared to weekdays.
